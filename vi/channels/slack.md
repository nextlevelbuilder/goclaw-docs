...
**Mời Bot vào Channel:**
- Trong bất kỳ channel nào, gõ `/add` và chọn **"Add apps to this channel"**, rồi chọn bot
- Hoặc: Tên channel → **Integrations** → **Add an App**
- DM: Nhắn tin trực tiếp cho bot — không cần mời
