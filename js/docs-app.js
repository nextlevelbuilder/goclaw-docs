...
const DOC_MAP = {
  ...
  'quick-start': docEntry('getting-started', 'quick-start', 'Quick Start', 'Quick Start'),
  ...
  'tts-voice': docEntry('advanced', 'tts-voice', 'TTS & Voice', 'TTS Voice'),
  ...
  'model-steering': docEntry('advanced', 'model-steering', 'Model Steering', 'Model Steering'),
  ...
  'deploy-database': docEntry('deployment', 'database-setup', 'Database Setup', 'Database Setup'),
  'deploy-security': docEntry('deployment', 'security-hardening', 'Security Hardening', 'Security Hardening'),
