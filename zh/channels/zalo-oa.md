...
Full Social API table: <https://developers.zalo.me/docs/social-api/tham-khao/ma-loi>. GoClaw's runtime classifies these codes internally as retriable, auth-refresh-triggering, or fatal — operators don't normally interact with that mapping; the symptom-based table above is the entry point for diagnostics.
